...
const proof = {
  ...
  "stateFixtures": {
    "ko": {
      "default": {
        "title": "오늘의 커뮤니티",
        "body": "관심 있는 사람들의 새 소식을 편안하게 둘러보세요.",
        "actionLabel": "새 글 쓰기",
      ...
      "success": {
        "title": "완료됐어요",
        "body": "로컬 작성 상태로 전환했습니다.",
        "actionLabel": "작성 화면 열림",
        "recoveryLabel": "기본 상태로 돌아가기",
        "recoverTo": null,
        "kind": "success",
        "busy": false,
    ...
    "en": {
      "default": {
        "title": "Today's community",
        "body": "Browse new posts from people and topics you care about.",
      ...
      "success": {
        "title": "All set",
        "body": "The example moved to its local compose state.",
        "actionLabel": "Composer opened",
        "recoveryLabel": "Return to default",
        "recoverTo": null,
        "kind": "success",
        "busy": false,
