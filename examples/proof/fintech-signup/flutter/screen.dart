...
class FintechSignupScreen extends StatefulWidget { const FintechSignupScreen({super.key}); @override State<FintechSignupScreen> createState() => _FintechSignupScreenState(); }
  ...
  @override Widget build(BuildContext context) {
    ...
    return SafeArea(child: Scaffold(backgroundColor: const Color(0xFFFFFFFF), body: Column(children: [
      Expanded(child: SingleChildScrollView(key: const Key('proof-scroll'), keyboardDismissBehavior: ScrollViewKeyboardDismissBehavior.onDrag, padding: EdgeInsets.fromLTRB(16, 24, 16, 100 + media.viewInsets.bottom), child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
        ...
        SizedBox(height: 24), TextField(keyboardType: TextInputType.phone, decoration: InputDecoration(labelText: model['field_label'])), SizedBox(height: 12), TextField(keyboardType: TextInputType.number, decoration: InputDecoration(labelText: model['secondary_label'])), SizedBox(height: 12), _Card(model['confirm_label']!, model['risk_notice']!, 16, 12)
      ]))),
