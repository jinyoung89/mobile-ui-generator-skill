...
export const requiredStates = ["default","loading","error","success","destructive_confirmation","empty","focused","filled","validation_error","keyboard","disabled","enabled"] as const;
...
export const stateFixtures = {
  "ko": {
    "default": {
      "title": "휴대폰 번호로 시작할게요",
      "body": "본인 명의 번호를 확인하면 안전하게 계정을 만들 수 있어요.",
      "actionLabel": "확인하고 계속",
    ...
    "success": {
      "title": "완료됐어요",
      "body": "휴대폰 본인 확인이 완료되었습니다.",
      "actionLabel": "본인 확인 완료",
      "recoveryLabel": "기본 상태로 돌아가기",
      "recoverTo": null,
      "kind": "success",
      "busy": false,
    ...
    "destructive_confirmation": {
      ...
      "body": "계좌 개설 전 이름과 휴대폰 명의가 일치하는지 확인하세요. 실제 인증이나 계좌 개설은 실행하지 않습니다.",
  ...
  "en": {
    "default": {
      "title": "Start with your phone number",
      "body": "Verify a number in your name to create the account safely.",
    ...
    "success": {
      "title": "All set",
      "body": "Phone verification is complete.",
    ...
    "destructive_confirmation": {
      ...
      "body": "Confirm that the account name and phone ownership match. This example does not perform identity verification or open an account.",
