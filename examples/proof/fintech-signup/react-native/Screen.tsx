...
type FintechSignupScreenProps = { initialState?: ProofState };
export function FintechSignupScreen({ initialState = 'default' }: FintechSignupScreenProps) {
...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', gap: 12, alignItems: 'flex-start' }, title: { color: '#111827', fontSize: 26, lineHeight: 34, fontWeight: '700' }, muted: { color: '#5B6472', lineHeight: 22 }, strong: { color: '#111827', fontWeight: '700', fontSize: 17 }, amount: { marginTop: 12, fontSize: 24, fontWeight: '800' }, badge: { color: '#1457D9', fontWeight: '800' },
  locale: { minWidth: 44, minHeight: 44, borderRadius: 22, borderWidth: 1, borderColor: '#D7DCE3', alignItems: 'center', justifyContent: 'center' }, input: { minHeight: 52, borderRadius: 12, borderWidth: 1, borderColor: '#AEB6C2', paddingHorizontal: 16 }, card: { gap: 12, padding: 16, borderRadius: 12, backgroundColor: '#F7F9FC' }, row: { flexDirection: 'row', alignItems: 'center', gap: 12 }, mark: { width: 44, height: 44, borderRadius: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: '#1457D9' }, markText: { color: '#FFFFFF', fontWeight: '800' },
  map: { minHeight: 280, borderRadius: 18, backgroundColor: '#DFEEE5', overflow: 'hidden' }, route: { position: 'absolute', top: 105, left: 88, width: 170, height: 72, borderRightWidth: 5, borderBottomWidth: 5, borderColor: '#1457D9', borderRadius: 36 }, pinA: { position: 'absolute', top: 64, left: 65, padding: 12, borderRadius: 24, color: '#FFFFFF', backgroundColor: '#1457D9' }, pinB: { position: 'absolute', right: 58, bottom: 54, padding: 12, borderRadius: 24, color: '#FFFFFF', backgroundColor: '#1457D9' }, eta: { position: 'absolute', top: 16, right: 16, padding: 10, borderRadius: 10, backgroundColor: '#FFFFFF', fontWeight: '800' }, risk: { color: '#B42318', lineHeight: 22 },
  stories: { flexDirection: 'row', gap: 12 }, story: { width: 56, height: 56, borderRadius: 28, borderWidth: 3, borderColor: '#1457D9', textAlign: 'center', paddingTop: 17, fontWeight: '800' }, avatar: { width: 44, height: 44, borderRadius: 22, alignItems: 'center', justifyContent: 'center', backgroundColor: '#1457D9' }, media: { minHeight: 220, borderRadius: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: '#E8EDF4' },
  messages: { minHeight: 390, justifyContent: 'flex-end', gap: 12 }, incoming: { alignSelf: 'flex-start', maxWidth: '78%', padding: 12, borderRadius: 18, backgroundColor: '#EDF0F4' }, outgoing: { alignSelf: 'flex-end', maxWidth: '78%', padding: 12, borderRadius: 18, color: '#FFFFFF', backgroundColor: '#1457D9' }, time: { alignSelf: 'center', color: '#717B89' }, composer: { flexDirection: 'row', gap: 12 }, send: { width: 52, height: 52, borderRadius: 26, alignItems: 'center', justifyContent: 'center', backgroundColor: '#1457D9' },
  statePanel: { gap: 6, padding: 16, borderRadius: 12, backgroundColor: '#EEF4FF' }, recover: { minHeight: 44, alignSelf: 'flex-start', justifyContent: 'center' }, recoverText: { color: '#1457D9', fontWeight: '700' }, riskGate: { minHeight: 52, flexDirection: 'row', alignItems: 'center', gap: 12, padding: 16, borderRadius: 12, backgroundColor: '#FFF7ED' },
  fixed: { minHeight: 84, paddingHorizontal: 16, paddingVertical: 12, backgroundColor: '#FFFFFF' }, action: { minHeight: 52, borderRadius: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: '#1457D9' }, pressed: { opacity: 0.82 }, actionDisabled: { opacity: 0.45 }, actionText: { color: '#FFFFFF', fontWeight: '800', fontSize: 16 },
});
