...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', gap: 12, alignItems: 'flex-start' }, title: { color: '#111827', fontSize: 26, lineHeight: 34, fontWeight: '700' }, muted: { color: '#5B6472', lineHeight: 22 }, strong: { color: '#111827', fontWeight: '700', fontSize: 17 }, amount: { marginTop: 12, fontSize: 24, fontWeight: '800' }, badge: { color: '#146C5A', fontWeight: '800' },
  locale: { minWidth: 44, minHeight: 44, borderRadius: 22, borderWidth: 1, borderColor: '#D7DCE3', alignItems: 'center', justifyContent: 'center' }, input: { minHeight: 52, borderRadius: 12, borderWidth: 1, borderColor: '#AEB6C2', paddingHorizontal: 16 }, card: { gap: 12, padding: 16, borderRadius: 12, backgroundColor: '#F7F9FC' }, row: { flexDirection: 'row', alignItems: 'center', gap: 12 }, mark: { width: 44, height: 44, borderRadius: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: '#146C5A' }, markText: { color: '#FFFFFF', fontWeight: '800' },
